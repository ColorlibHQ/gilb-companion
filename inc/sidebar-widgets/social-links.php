...
class Gilb_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Gilb ] Social Links', 'gilb' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'gilb' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'gilb' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'gilb'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'gilb'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'gilb'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'gilb'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'gilb'); ?></label>
...
} // Class gilb_social_links ends here


// Register and load the widget
function gilb_social_links_widget_load() {
	register_widget( 'Gilb_social_links' );
}
add_action( 'widgets_init', 'gilb_social_links_widget_load' );