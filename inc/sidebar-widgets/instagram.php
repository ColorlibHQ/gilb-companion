...
----------------------------------------*/
class gilb_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('gilb_instagram_photo',esc_html__('[ Gilb ] Intagram Photo','gilb'),array(
			'description' => esc_html__('Gilb Instagram Photo Widget','gilb'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'gilb');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'gilb'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'gilb'); ?></label>
...
if(!function_exists('gilb_instagram_widgets')):
	function gilb_instagram_widgets(){
		register_widget('gilb_instagram_photo');
	}
	add_action('widgets_init','gilb_instagram_widgets');
endif;
